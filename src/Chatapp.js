...
function Chatapp() {
  ...
  return (
    <div>
      <div>
        <Container fluid style={{ backgroundColor: "#b2bec3" }}>
          <Row>
                ...
                <div className={Chat.chat1 ? "chatbox" : "chatboxnull"}>
                  <div className="chathouse mt-5">
                    ...
                    <div className="chatdiv">
                      {use.map((msg) => {
                        console.log(msg);
                        return <h1 className="chatstate">{msg.name}</h1>;
                      })}
                    </div>
                ...
                <div className={Chat.chat2 ? "chatbox" : "chatboxnull"}>
                  <div className="chathouse mt-5">
                    ...
                    <div className="chatdiv">
                      {use.map((msg) => {
                        console.log(msg);
                        return <h1 className="chatstate">{msg.name2}</h1>;
                      })}
                    </div>
                    ...
                    <div className="textbox">
                      <span>
                        <input
                          ...
                          placeholder={"Write a message here..."}
                          onChange={(e) => {
                            setMessage({ name2: e.target.value });
                          }}
                          value={message.name2}
                        />
                      </span>
                ...
                <div className={Chat.chat3 ? "chatbox" : "chatboxnull"}>
                  <div className="chathouse mt-5">
                    ...
                    <div className="chatdiv">
                      {use.map((msg) => {
                        console.log(msg);
                        return <h1 className="chatstate">{msg.name3}</h1>;
                      })}
                    </div>
                    ...
                    <div className="textbox">
                      <span>
                        <input
                          ...
                          placeholder={"Write a message here..."}
                          onChange={(e) => {
                            setMessage({ name3: e.target.value });
                          }}
                          value={message.name3}
                        />
                      </span>
                ...
                <div className={Chat.chat4 ? "chatbox" : "chatboxnull"}>
                  <div className="chathouse mt-5">
                    ...
                    <div className="chatdiv">
                      {use.map((msg) => {
                        console.log(msg);
                        return <h1 className="chatstate">{msg.name4}</h1>;
                      })}
                    </div>
                    ...
                    <div className="textbox">
                      <span>
                        <input
                          ...
                          placeholder={"Write a message here..."}
                          onChange={(e) => {
                            setMessage({ name4: e.target.value });
                          }}
                          value={message.name4}
                        />
                      </span>
                ...
                <div className={Chat.chat5 ? "chatbox" : "chatboxnull"}>
                  <div className="chathouse mt-5">
                    ...
                    <div className="chatdiv">
                      {use.map((msg) => {
                        console.log(msg);
                        return <h1 className="chatstate">{msg.name5}</h1>;
                      })}
                    </div>
                    ...
                    <div className="textbox">
                      <span>
                        <input
                          ...
                          placeholder={"Write a message here..."}
                          onChange={(e) => {
                            setMessage({ name5: e.target.value });
                          }}
                          value={message.name5}
                        />
                      </span>
